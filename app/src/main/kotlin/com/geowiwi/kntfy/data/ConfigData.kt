...
data class WebhookData(
    ...
    val statusTextOnStop: String = "Stopped",
    val actionOnStart: Boolean = false,
    val statusTextOnStart: String = "Started",
    val actionOnPause: Boolean = false,
    val statusTextOnPause: String = "Paused",
    val actionOnResume: Boolean = false,
    val statusTextOnResume: String = "Resumed",
    val actionOnCustom: Boolean = true,
    val statusTextOnCustom: String = "Custom",
